...
<div id="list-optionsRecord" class="content scaffold-list" role="main">
    ...
    <div class="table-container">
        <div class="operation">
            <a class="small-btn back glyphicon glyphicon-arrow-left" title="返回" href="/stock/optionsRecord/list"  > </a>
            ...
            <sec:ifAnyGranted roles='${util.ConstantUtil.ROLE_ADMIN}'>
                <a class="small-btn refresh glyphicon glyphicon-plus" title="交易" href="/stock/optionsRecord/create/${userId}"> </a>
            </sec:ifAnyGranted>
        </div>
                    ...
                    <td>${CommonUtil.subString(oneEntity.remark)}</td>
                        ...
                        <td>
                            <g:form resource="${oneEntity}" method="DELETE">
                                <a class="td-btn glyphicon glyphicon-list-alt" title="详细信息" href="/stock/optionsRecord/show?id=${oneEntity.id}&userId=${userId}"></a>
                                <sec:ifAnyGranted roles='${util.ConstantUtil.ROLE_ADMIN}'>
                                <a class="td-btn glyphicon glyphicon-wrench" title="编辑" href="/stock/optionsRecord/edit?id=${oneEntity.id}&userId=${userId}"></a>
