...
<div class="table-container">
    ...
    <div id="create-optionsRecord" class="content scaffold-create" role="main">
        ...
        <form action="/optionsRecord/save" method="post">
            ...
            <div class="input-group date date-show" data-provide="datepicker" data-date-format="${ConstantUtil.JS_DATE_FORMATE_STR}">
                <input type="text" class="form-control" value="${optionsRecord&&optionsRecord.transactionDate? optionsRecord.transactionDate: new Date().format(ConstantUtil.JAVA_DATE_FORMATE_STR)}" name="transactionDate" value="" required="" id="transactionDate"  placeholder="交易日期">
