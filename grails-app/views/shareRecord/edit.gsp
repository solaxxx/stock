...
<html>
    ...
    <div class="table-container">
        ...
        <div id="edit-shareRecord" class="content scaffold-create" role="main">
            ...
            <form action="/shareRecord/update" method="put">
                ...
                <div class="input-group date date-show" data-provide="datepicker" data-date-format="${util.ConstantUtil.JS_DATE_FORMATE_STR}">
                    <input type="text" class="form-control" value="${shareRecord&&shareRecord.transactionDate?  shareRecord.transactionDate.format("yyyy-MM-dd"): new Date().format(util.ConstantUtil.JAVA_DATE_FORMATE_STR)}" name="transactionDate" value="" required="" id="transactionDate"  placeholder="交易日期">
                ...
                <div class="textArea-group">
                    ...
                    <textarea class="form-control"name="remark" id="remark" rows="3">${shareRecord&&shareRecord.remark?shareRecord.remark:''}</textarea>
                </div>
